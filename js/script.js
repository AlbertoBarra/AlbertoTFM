...
var renfeGarMarker = L.marker([40.480514, -3.393043], {icon: renfeIcon}).addTo(map).bindPopup(renfeGarPop)

var renfeAHPop = "<a href='https://www.redtransporte.com/madrid/cercanias-renfe/horarios.html'target='_blank'>Alcalá de Henares</a>"
var renfeAHMarker = L.marker([40.489025, -3.366277], {icon: renfeIcon}).addTo(map).bindPopup(renfeAHPop)
...
var renfeAHUMarker = L.marker([40.505380, -3.335340], {icon: renfeIcon}).addTo(map).bindPopup(renfeAHUPop)

var renfeMecoPop = "<a href='https://www.redtransporte.com/madrid/cercanias-renfe/horarios.html'target='_blank'>Meco</a>"
var renfeMecoMarker = L.marker([40.534581, -3.298734], {icon: renfeIcon}).addTo(map).bindPopup(renfeMecoPop)

var renfeAzqPop = "<a href='https://www.redtransporte.com/madrid/cercanias-renfe/horarios.html'target='_blank'>Azuqueca</a>"
var renfeAzqMarker = L.marker([40.561031, -3.265453], {icon: renfeIcon}).addTo(map).bindPopup(renfeAzqPop)

var renfeGuadPop = "<a href='https://www.redtransporte.com/madrid/cercanias-renfe/horarios.html'target='_blank'>Guadalajada</a>"
var renfeGuadMarker = L.marker([40.644233, -3.182273], {icon: renfeIcon}).addTo(map).bindPopup(renfeGuadPop)
